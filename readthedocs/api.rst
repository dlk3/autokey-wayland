...
imported to add additional capabilities when writng in an AutoKey script.
...
``autokey.scripting.Keyboard.press_key()`` method shown in the documentation is 
actually called in a script as ``keyboard.press_key()``.  This applies across 
the bopard to all of the API classes documented here.
