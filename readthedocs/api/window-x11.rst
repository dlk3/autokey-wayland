...
There are three different implementations of the "window" class, one for GNOME/Wayland
environments, one for KDE/Wayland environments, and one for X11.  This is the X11 version.
