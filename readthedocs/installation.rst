...
AutoKey for Wayland can be installed on both X11 and Wayland systems.  On Wayland systems, it only works with the GNOME desktop.  The KDE desktop is not yet supported.
