...
```
pydoctor --docformat=restructuredtext --project-name="AutoKey Script" --project-version=0.97.2 --project-url=https://github.com/dlk3/autokey-wayland --html-viewsource-base=https://github.com/dlk3/autokey-wayland/tree/v0.97.2 --html-output=doc/script lib/autokey/scripting/*
```
